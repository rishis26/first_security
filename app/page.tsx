    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 py-32 text-center">
        <div className="mx-auto w-full max-w-4xl space-y-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 rounded border border-green-500/30 bg-green-500/5 px-4 py-2 text-xs font-medium text-green-500">
          ...
          <div className="flex flex-col justify-center gap-4 pt-4 sm:flex-row">
            <Link
              href="#services"
              className="rounded bg-green-500 px-8 py-4 text-sm font-semibold text-black transition-colors hover:bg-green-400"
            >
              Get Started - $500
            </Link>
            <Link
              href="#services"
              className="rounded border border-gray-700 px-8 py-4 text-sm font-semibold text-white transition-colors hover:border-green-500 hover:text-green-500"
            >
              View Services
            </Link>
          </div>
      ...
      <section id="services" className="bg-zinc-950 px-6 py-20">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {/* Quick Web Scan */}
            <div className="rounded-lg border border-gray-800 bg-black p-8 transition-all hover:border-green-500/50">
              ...
              <button className="w-full rounded border border-gray-700 py-3 text-sm font-semibold transition-colors hover:border-green-500 hover:text-green-500">
                Get Started
              </button>
            </div>

            {/* Full Pentest - Featured */}
            <div className="relative rounded-lg border-2 border-green-500 bg-black p-8">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-green-500 px-4 py-1 text-xs font-bold text-black">
                RECOMMENDED
              </div>

              <div className="mb-4 text-sm text-green-500">Most Popular</div>

              <h3 className="mb-3 text-2xl font-bold text-green-500">Full Pentest</h3>
              ...
              <button className="w-full rounded bg-green-500 py-3 text-sm font-semibold text-black transition-colors hover:bg-green-400">
                Get Started
              </button>
            </div>
